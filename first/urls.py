...
urlpatterns = [
    ...
    re_path(r'^shop/categories/mobiles/$', ListView.as_view(queryset = models.Mobile.objects.all(), template_name = "first/mobile-card.html"),name = 'list'),
    ...
    re_path(r'^shop/categories/mobiles/(?P<pk>\d+)/$' , views.product_detail , name = 'detail'),
]
